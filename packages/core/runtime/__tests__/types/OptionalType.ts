...
describe('OptionalType', () => {
  ...
  test('mock', () => {
    ...
    const result = tuple.deriveLiteral([], context).mock();
  ...
  test('validate', () => {
    ...
    expect(tuple.validate(['haha', 'heihei'], context)).toBe(true);
    expect(tuple.validate(['haha', 'heihei', 'hoho'], context)).toBe(true);
    expect(tuple.validate(['haha', 'heihei', 'lala'], context)).toBe(false);
    expect(tuple.validate(['haha'], context)).toBe(false);
  });
});
